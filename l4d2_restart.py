...
#
# https://github.com/TyUser/l4d2_install_hx
#
...
def l4d2_restart_update():
    ...
    time.sleep(2)
    os.system(
        "screen -dmS l4d2 ./steamcmd/l4d2/srcds_run -game left4dead2 -port 27015 +map c1m1_hotel -maxplayers 20 -secure +sv_lan 0")
